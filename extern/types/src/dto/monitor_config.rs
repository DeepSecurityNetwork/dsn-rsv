...
pub struct Config {
    ...
    pub bool_config: Option<DeepSafeConfig>,
...
pub struct DeepSafeConfig {
    /// Used to call bool node.
    pub bool_node_url: String,
    /// Hex encoded secret key for DeepSafe account.
    pub bool_identity: Option<String>,
    /// DeepSafe client warn time limit(milliseconds)
...
mod tests {
    ...
    fn config_deserialize_test() {
        let str = r#"
        port = 8740
        database_url = "/deepsafe/data/sqlite.db"
