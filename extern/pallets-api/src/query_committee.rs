...
pub async fn registers(sub_client: &DeepSafeSubClient, at_block: Option<Hash>) -> Option<Vec<DIdentity>> {
...
pub async fn snapshot(sub_client: &DeepSafeSubClient, at_block: Option<Hash>) -> Option<Vec<Vec<u8>>> {
...
pub async fn committee_randomness(sub_client: &DeepSafeSubClient, cid: u32, at_block: Option<Hash>) -> Option<u64> {
