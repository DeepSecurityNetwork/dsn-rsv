...
use subxt::{
    OnlineClient, Config, tx::{TxPayload, SecretKey, DeepSafeSigner}, JsonRpseeError,
...
impl SubClient<DeepSafeConfig, DeepSafeSigner<DeepSafeConfig>> {
    ...
    >(
        ...
        let tx: subxt::tx::SubmittableExtrinsic<DeepSafeConfig, OnlineClient<DeepSafeConfig>> = client.tx().create_signed_with_nonce(&call, signer, target_nonce, Default::default())?;
